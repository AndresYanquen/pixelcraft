...
<header id="masthead">
	...
	<?php
		...
		if ( $pixelcraft_description || is_customize_preview() ) :
			?>
			<p><?php echo $pixelcraft_description; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></p>
		<?php endif; ?>
	</div>

	<nav id="site-navigation" aria-label="<?php esc_attr_e( 'Main Navigation', 'pixelcraftc' ); ?>">
		<div class="">
