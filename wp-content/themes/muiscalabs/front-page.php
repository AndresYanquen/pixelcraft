        ...
        <div class="row align-items-center">
          <div class="col-lg-6 position-relative" data-aos="fade-right" data-aos-delay="200">
            <div class="about-image">
              <img src="<?php echo get_template_directory_uri() . '/assets/img/profile/profile-square-2.webp'?>" alt="Profile Image" class="img-fluid rounded-4">
            </div>
          </div>
            ...
            <div class="about-content">
              ...
              <div class="signature mt-4">
                <div class="signature-image">
                  <img src="<?php echo get_template_directory_uri() . '/assets/img/misc/signature-1.webp"'?>"alt="" class="img-fluid">
                </div>
                ...
                <div class="row">
                  <div class="col-lg-8">
                    ...
                    <div class="profile d-flex align-items-center">
                      <img src="<?php echo get_template_directory_uri() . '/assets/img/person/person-m-7.webp'?>" class="profile-img" alt="">
                  ...
                  <div class="col-lg-4 d-none d-lg-block">
                    <div class="featured-img-wrapper">
                      <img src="<?php echo get_template_directory_uri() . '/assets/img/person/person-m-7.webp'?>" class="featured-img" alt="">
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="testimonial-item">
                <div class="row">
                  <div class="col-lg-8">
                    ...
                    <div class="profile d-flex align-items-center">
                      <img src="<?php echo get_template_directory_uri() . '/assets/img/person/person-f-8.webp'?>" class="profile-img" alt="">
                      <div class="profile-info">
                        <h3>Sara Wilsson</h3>
                        <span>Designer</span>
                      </div>
                  ...
                  <div class="col-lg-4 d-none d-lg-block">
                    <div class="featured-img-wrapper">
                      <img src="<?php echo get_template_directory_uri() . '/assets/img/person/person-f-8.webp'?>" class="featured-img" alt="">
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="testimonial-item">
                <div class="row">
                  <div class="col-lg-8">
                    ...
                    <div class="profile d-flex align-items-center">
                      <img src="<?php echo get_template_directory_uri() . '/assets/img/person/person-m-9.webp'?>" class="profile-img" alt="">
                      <div class="profile-info">
                        <h3>Matt Brandon</h3>
                  ...
                  <div class="col-lg-4 d-none d-lg-block">
                    <div class="featured-img-wrapper">
                      <img src="<?php echo get_template_directory_uri() . '/assets/img/person/person-m-9.webp'?>" class="featured-img" alt="">
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="testimonial-item">
                <div class="row">
                  <div class="col-lg-8">
                    ...
                    <div class="profile d-flex align-items-center">
                      <img src="<?php echo get_template_directory_uri() . '/assets/img/person/person-f-10.webp'?>" class="profile-img" alt="">
                      <div class="profile-info">
                        <h3>Jena Karlis</h3>
                  ...
                  <div class="col-lg-4 d-none d-lg-block">
                    <div class="featured-img-wrapper">
                      <img src="<?php echo get_template_directory_uri() . '/assets/img/person/person-f-10.webp'?>" class="featured-img" alt="">
                    </div>
                  </div>
                </div>
              </div>
